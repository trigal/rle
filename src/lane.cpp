...
void setStateTransitionMatrix()
{
    ...
    else if (howManyLanes == 4)
    {
        ...
        if(EXEC_TEST==1)
        {
            ROS_INFO_STREAM("Executing test "+EXEC_TEST);
            testname="0.72+0902";
...
void chatterCallback(const road_layout_estimation::msg_lines & msg_lines)
{
    ...
    ///STATS
    ofstream myfile;
    myfile.open ("/home/ballardini/Desktop/"+testname+".txt", ios::app);
    ...
    ofstream myfile2;
    myfile2.open ("/home/ballardini/Desktop/"+testname+".short.txt", ios::app);
...
int main(int argc, char **argv)
{
    ...
    *chatter_pub = n.advertise<std_msgs::Bool>("/sync", 1);
    ...
    ros::Subscriber sub = n.subscribe("/isis_line_detector/lines", 1000, chatterCallback);
